...
const module = {
    setup(){
        ...
        const musicInfo = Vue.reactive({
            ...
            singer:"The Kiboomers",
            backgroundImageUrl:"./sources/images/TOGETOGE2.jpg",
            imageUrl:"./sources/images/NiNaBirthday.jpg",
            musicUrl:"./sources/musics/HappyBirthday.mp3",
        });
        ...
        const handleSong =()=>{
            if(musicInfo.isLjyNb){
                ...
                musicInfo.name="Happy Birthday to You";
                musicInfo.singer="The Kiboomers";
                musicInfo.backgroundImageUrl="./sources/images/TOGETOGE2.jpg",
                musicInfo.imageUrl="./sources/images/NiNaBirthday.jpg"
                musicInfo.musicUrl="./sources/musics/HappyBirthday.mp3";
            }else{
                musicInfo.isLjyNb=true;
                musicInfo.name="だんご大家族";
                musicInfo.singer="VISUAL ARTS";
                musicInfo.backgroundImageUrl="./sources/images/AS3.jpg",
                musicInfo.imageUrl="./sources/images/GuiZhuDeXi.jpg"
                musicInfo.musicUrl="./sources/musics/DanGoDaiGaZoKu.mp3";
            }
            handleDuration();
        }
